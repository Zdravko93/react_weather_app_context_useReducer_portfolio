      ...
      <Card WRAPPER="div" className={classes["weather-details-wind"]}>
        ...
        >
          ...
          <ToggleUnit>
            ...
            >
              <h6 id="wind-status-group" className="visually-hidden">
                Wind orientation and unit toggle
              </h6>
              <Button
                ariaLabel={`Toggle wind speed unit to ${
                  isMetric ? "km/h" : "m/s"
                }$`}
                ariaDescribedBy="wind-toggle-tooltip"
                ariaPressed={isMetric}
                className={`${unitToggleClasses["toggle-unit-btn"]} ${unitToggleClasses["toggle-unit-btn-wind-speed"]}`}
                callback={toggleWindSpeedUnit}
              >
                {isMetric ? "m/s" : "km/h"}
                <span
                  id="wind-toggle-tooltip"
